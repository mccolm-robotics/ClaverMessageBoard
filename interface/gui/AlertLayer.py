...
class AlertLayer:
    ...
    def __build_layer(self):
        ...
        # A box to fill the entire layer area with semi-transparent background color
        ...
        alert_box = Gtk.Box()  # Create a new layout box
        # alert_box.set_text("This is an alert")  # Set the value of the label text
        alert_box.get_style_context().add_class('alert')  # Connect a CSS class to the box
        ...
        alert_box.add(self.alert_box_content)
